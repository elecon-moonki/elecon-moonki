...
import urllib.parse
from manufacturer_api import manufacturer
from product_api import product
from shipping_api import shipping
...
register_tortoise(
    app, db_url=f'mysql://{USER}:{PASSWORD}@{HOST}:3306/{DATABASE}', modules={'models': ['models']}, generate_schemas=True)
